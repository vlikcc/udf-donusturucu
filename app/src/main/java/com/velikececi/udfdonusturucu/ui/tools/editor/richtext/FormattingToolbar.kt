    ...
    Surface(tonalElevation = 2.dp, modifier = modifier) {
        Row(
            ...
            IconButton(onClick = { coordinator.setAlignment(0) }) {
                Icon(Icons.AutoMirrored.Filled.FormatAlignLeft, contentDescription = "Sola Yasla")
            }
            ...
            IconButton(onClick = { coordinator.setAlignment(2) }) {
                Icon(Icons.AutoMirrored.Filled.FormatAlignRight, contentDescription = "Sağa Yasla")
            }
        }
    }
}
