...
```
Evrak Dönüştürücü - UDF Çevirici
```

> 30 karakter sınırına uygun. "UDF" anahtar kelimesini içeriyor.
...
```
UYAP UDF Dosyalarını PDF'e Çevir
```

> 30 karakter sınırına uygun.
...
```
UYAP'tan indirdiğiniz UDF belgelerini saniyeler içinde PDF veya Word formatına dönüştürün. Tamamen cihazınızda, güvenli ve hızlı!
```

> 170 karaktere kadar izin verilir. İnceleme gerektirmeden her zaman güncellenebilir.

---

## Uygulama Açıklaması (Description)

```
Evrak Dönüştürücü, UYAP sisteminden indirdiğiniz .udf uzantılı belgeleri kolayca PDF veya Microsoft Word (.docx) formatına dönüştürmenizi sağlayan pratik bir uygulamadır.

NASIL ÇALIŞIR?
1. UDF dosyanızı seçin
2. PDF veya DOCX formatını belirleyin
3. "Dönüştür" butonuna dokunun
Hepsi bu kadar! Dönüştürülen belgenizi anında paylaşabilir veya Dosyalar'a kaydedebilirsiniz.

TERS YÖN DESTEĞİ
PDF veya Word belgelerinizi UDF formatına da çevirebilirsiniz.

GÜVENLİK ÖNCELİĞİMİZ
Tüm dönüştürme işlemleri tamamen cihazınız üzerinde gerçekleşir. Belgeleriniz hiçbir sunucuya yüklenmez, üçüncü taraflarla paylaşılmaz. Verileriniz yalnızca sizin kontrolünüzdedir.

ÖZELLİKLER
• UDF → PDF dönüştürme
• UDF → Word (.docx) dönüştürme
• PDF → UDF dönüştürme
• DOCX → UDF dönüştürme
...
```
UDF,UYAP,belge,dönüştürücü,PDF,DOCX,Word,evrak,çevirici,hukuk
```

> 100 karakter sınırı. Virgülle ayrılmış, boşluksuz. Her kelime arama sonuçlarında eşleşme sağlar.

**Alternatif kombinasyon (daha geniş kapsam):**
```
UDF,UYAP,dönüştürücü,PDF,Word,belge,evrak,dosya,çevir,avukat
```
...
> "Utilities" da uygun olabilir, ancak "Productivity" belge dönüştürme uygulamaları için App Store'da daha yüksek görünürlük sağlar.
...
## Yaş Sınıflandırması Anketi İçin Notlar

App Store Connect'te yaş derecelendirmesi anketinde şu yanıtları verin:

| Soru | Yanıt |
|------|-------|
| Şiddet içeriği | Yok |
| Cinsel içerik | Yok |
| Uyuşturucu referansı | Yok |
| Kumar | Yok |
...
**Beklenen sonuç:** 4+ (Dört yaş ve üstü)

---

## İhracat Uyumluluk (Encryption)

App Store Connect'te sorulacak şifreleme sorusu:

| Soru | Yanıt |
|------|-------|
| Uygulamanız şifreleme kullanıyor mu? | **Evet** (HTTPS üzerinden AdMob reklam istekleri ve StoreKit iletişimi) |
| Şifreleme yalnızca standart iOS API'leri mi? | **Evet** (App Transport Security / URLSession / StoreKit) |
| İhracat muafiyeti var mı? | **Evet** — standart iOS şifreleme kullandığı için muaf |

> Sonuç olarak ihracat uyumluluk belgesi gerekmez.

---

## Özet Kontrol Listesi

- [ ] Uygulama adı: `Evrak Dönüştürücü - UDF Çevirici`
- [ ] Alt başlık: `UYAP UDF Dosyalarını PDF'e Çevir`
- [ ] Tanıtım metni girildi
- [ ] Uygulama açıklaması girildi
